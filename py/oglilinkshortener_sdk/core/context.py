...
from oglilinkshortener_sdk.core.control import OgliLinkShortenerControl
...
from oglilinkshortener_sdk.core.helpers import get_ctx_prop, to_map
...
class OgliLinkShortenerContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = OgliLinkShortenerControl()
        ...
        if isinstance(sp, OgliLinkShortenerSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OgliLinkShortenerResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OgliLinkShortenerResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return OgliLinkShortenerOperation({})
    ...
    def make_error(self, code, msg):
        return OgliLinkShortenerError(code, msg, self)
