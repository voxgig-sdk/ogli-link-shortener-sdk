...
from oglilinkshortener_sdk.utility import register

# Load features
from oglilinkshortener_sdk.feature.base_feature import OgliLinkShortenerBaseFeature
from oglilinkshortener_sdk.features import _has_feature, _make_feature
...
class OgliLinkShortenerSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = OgliLinkShortenerUtility()
    ...
    def get_utility(self):
        return OgliLinkShortenerUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OgliLinkShortenerSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Link(self, data=None) -> "LinkEntity":
        ...
        from oglilinkshortener_sdk.entity.link_entity import LinkEntity
    ...
    def LinkStat(self, data=None) -> "LinkStatEntity":
        ...
        from oglilinkshortener_sdk.entity.link_stat_entity import LinkStatEntity
