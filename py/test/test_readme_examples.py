# OgliLinkShortener SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OgliLinkShortenerSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OgliLinkShortenerSDK(...) and OgliLinkShortenerSDK.test(...) become
#      OgliLinkShortenerSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "oglilinkshortener_sdk"
_SDK_CLASS = "OgliLinkShortenerSDK"
