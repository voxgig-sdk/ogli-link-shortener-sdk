// Command OgliLinkShortener-cli is a CLI + REPL for the OgliLinkShortener SDK,
...
const prompt = "ogli-link-shortener"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "link link_stat"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      OGLI_LINK_SHORTENER_APIKEY (api key), OGLI_LINK_SHORTENER_BASE (base url override)")
