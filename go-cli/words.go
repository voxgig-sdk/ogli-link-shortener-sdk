...
func registerSDKWords(r *eng.Registry, client *sdk.OgliLinkShortenerSDK) {
...
func runOp(client *sdk.OgliLinkShortenerSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
