...
class LinkStatEntity
  ...
  def make
    opts = @_entopts.dup
    LinkStatEntity.new(@_client, opts)
  end
  ...
  # @return [LinkStat, Hash] the current LinkStat data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LinkStat fields)
  def match_get
  ...
  #
  # @param reqmatch [LinkStatListMatch, Hash, nil] match filter (any subset of
  #   LinkStat fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<LinkStat>, Array] the matching LinkStat items; raises OgliLinkShortenerError on failure
