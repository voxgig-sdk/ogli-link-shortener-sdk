...
class LinkEntity
  ...
  #   as an empty match, so client.Link.load works with no args).
  ...
  #
  # @param reqmatch [LinkListMatch, Hash, nil] match filter (any subset of
  #   Link fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
