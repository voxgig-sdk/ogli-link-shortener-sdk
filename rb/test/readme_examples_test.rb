...
#      offline in seeded test mode (OgliLinkShortenerSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OgliLinkShortener_sdk.rb")
  SDK_CLASS = "OgliLinkShortenerSDK"
  ...
  SDK_BASE = "OgliLinkShortener_sdk"
