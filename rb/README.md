...
The Ruby SDK for the OgliLinkShortener API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `OgliLinkShortenerError` (a `StandardError` subclass), so wrap
