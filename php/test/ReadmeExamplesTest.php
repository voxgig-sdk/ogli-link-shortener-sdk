...
// OgliLinkShortener SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OgliLinkShortenerSDK::test)
...
{
    private const SDK_CLASS = 'OgliLinkShortenerSDK';
    ...
    private const SDK_BASE = 'oglilinkshortener_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../oglilinkshortener_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
