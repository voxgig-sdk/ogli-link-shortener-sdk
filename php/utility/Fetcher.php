...
// OgliLinkShortener SDK utility: fetcher

class OgliLinkShortenerFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OgliLinkShortenerSDK/1.0)';
    ...
    public static function call(OgliLinkShortenerContext $ctx, string $fullurl, array $fetchdef): array
    {
