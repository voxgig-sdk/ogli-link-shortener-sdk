...
// OgliLinkShortener SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OgliLinkShortenerMakeRequest
{
    public static function call(OgliLinkShortenerContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OgliLinkShortenerResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OgliLinkShortenerResponse($fetched);
        } else {
