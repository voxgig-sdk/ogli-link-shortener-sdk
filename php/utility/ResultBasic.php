...
// OgliLinkShortener SDK utility: result_basic

class OgliLinkShortenerResultBasic
{
    public static function call(OgliLinkShortenerContext $ctx): ?OgliLinkShortenerResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof OgliLinkShortenerError) ? $result->err->msg : (string)$result->err;
