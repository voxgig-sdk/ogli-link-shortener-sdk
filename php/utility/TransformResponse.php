...
// OgliLinkShortener SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OgliLinkShortenerTransformResponse
{
    public static function call(OgliLinkShortenerContext $ctx): mixed
    {
        ...
        $transform = OgliLinkShortenerHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
