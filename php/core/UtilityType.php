...
// OgliLinkShortener SDK utility type

class OgliLinkShortenerUtility
{
    ...
    public static function copy(OgliLinkShortenerUtility $src): OgliLinkShortenerUtility
    {
        $u = new OgliLinkShortenerUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
