...
// OgliLinkShortener SDK metrics feature
...
class OgliLinkShortenerMetricsFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _record(OgliLinkShortenerContext $ctx, bool $ok): void
    {
