...
// OgliLinkShortener SDK proxy feature
...
class OgliLinkShortenerProxyFeature extends OgliLinkShortenerBaseFeature
{
    ...
    public function init(OgliLinkShortenerContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OgliLinkShortenerContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
