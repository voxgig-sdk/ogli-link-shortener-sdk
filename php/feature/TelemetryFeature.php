...
// OgliLinkShortener SDK telemetry feature
...
class OgliLinkShortenerTelemetryFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _close(OgliLinkShortenerContext $ctx, bool $ok): void
    {
