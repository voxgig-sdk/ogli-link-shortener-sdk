...
// OgliLinkShortener SDK cache feature
...
class OgliLinkShortenerCacheFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _through(OgliLinkShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
