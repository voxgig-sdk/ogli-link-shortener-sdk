...
// OgliLinkShortener SDK idempotency feature
...
class OgliLinkShortenerIdempotencyFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _mutating(OgliLinkShortenerContext $ctx): bool
    {
