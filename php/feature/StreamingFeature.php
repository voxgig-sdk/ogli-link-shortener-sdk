...
// OgliLinkShortener SDK streaming feature
...
class OgliLinkShortenerStreamingFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _iterate(OgliLinkShortenerResult $result): \Generator
    {
    ...
    private function _streamable(OgliLinkShortenerContext $ctx): bool
    {
