...
// OgliLinkShortener SDK rbac feature
...
class OgliLinkShortenerRbacFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _required(OgliLinkShortenerContext $ctx): ?string
    {
    ...
    private function _reject(OgliLinkShortenerContext $ctx, string $required): void
    {
    ...
    private function _track(OgliLinkShortenerContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
