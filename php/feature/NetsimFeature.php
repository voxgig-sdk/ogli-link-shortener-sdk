...
// OgliLinkShortener SDK netsim feature
...
class OgliLinkShortenerNetsimFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _simulate(OgliLinkShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OgliLinkShortenerContext $ctx, array $applied): void
    {
        $client = $this->client;
