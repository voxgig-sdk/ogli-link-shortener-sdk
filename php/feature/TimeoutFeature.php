...
// OgliLinkShortener SDK timeout feature
...
class OgliLinkShortenerTimeoutFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _with_timeout(OgliLinkShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OgliLinkShortenerContext $_ctx, float $ms): void
    {
        $client = $this->client;
