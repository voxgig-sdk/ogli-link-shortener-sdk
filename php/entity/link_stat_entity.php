...
// OgliLinkShortener SDK LinkStat entity
...
class LinkStatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LinkStatEntity($this->_client, $opts);
    }

    /**
     * @param LinkStat|array $args LinkStat data (assoc-array) to store.
     */
    ...
    /**
     * @return LinkStat|array The current LinkStat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LinkStat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LinkStat fields).
     */
    ...
    /**
     * List LinkStat items matching the given filter.
     *
     * @param LinkStatListMatch|array|null $reqmatch Match filter (any subset
     *   of LinkStat fields) as an assoc-array; LinkStatListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LinkStat[]|array A list of LinkStat items as assoc-arrays at
