...
const testSeed = `map[string]any{"entity": map[string]any{"link": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "link_stat": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
