...
class LinkEntity extends OgliLinkShortenerEntityBase<Link> {
  ...
  async load(this: any, reqmatch?: LinkLoadMatch, ctrl?: Control): Promise<LinkEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Link> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: LinkListMatch, ctrl?: Control): Promise<LinkEntity[]> {
  ...
  async create(this: any, reqdata?: LinkCreateData, ctrl?: Control): Promise<LinkEntity> {
  ...
  async update(this: any, reqdata?: LinkUpdateData, ctrl?: Control): Promise<LinkEntity> {
  ...
  async remove(
    this: any, reqmatch?: LinkRemoveMatch, ctrl?: Control,
  ): Promise<LinkEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<LinkEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
