...
(0, node_test_1.describe)('LinkDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OgliLinkShortenerSDK({
    ...
    (0, node_test_1.test)('direct-load-link', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-link', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-link', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-link', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OgliLinkShortenerSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.OGLI_LINK_SHORTENER_APIKEY,
        }));
        let idmap = env['OGLI_LINK_SHORTENER_TEST_LINK_ENTID'];
    ...
    const client = new __1.OgliLinkShortenerSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LinkDirect.test.js.map