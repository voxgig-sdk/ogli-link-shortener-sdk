...
(0, node_test_1.describe)('LinkStatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-link_stat', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-link_stat', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["link_stat01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.id = setup.idmap['link_stat01'];
        }
        else {
            params.id = 'direct01';
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OGLI_LINK_SHORTENER_TEST_LINK_STAT_ENTID'];
...
//# sourceMappingURL=LinkStatDirect.test.js.map