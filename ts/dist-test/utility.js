...
function envOverride(m) {
    if ('TRUE' === process.env.OGLI_LINK_SHORTENER_TEST_LIVE ||
        'TRUE' === process.env.OGLI_LINK_SHORTENER_TEST_OVERRIDE) {
    ...
    m.OGLI_LINK_SHORTENER_TEST_EXPLAIN = process.env.OGLI_LINK_SHORTENER_TEST_EXPLAIN || m.OGLI_LINK_SHORTENER_TEST_EXPLAIN;
    return m;
}
