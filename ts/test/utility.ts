...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.OGLILINKSHORTENER_TEST_LIVE ||
    'TRUE' === process.env.OGLILINKSHORTENER_TEST_OVERRIDE
  ) {
  ...
  m.OGLILINKSHORTENER_TEST_EXPLAIN = process.env.OGLILINKSHORTENER_TEST_EXPLAIN || m.OGLILINKSHORTENER_TEST_EXPLAIN
