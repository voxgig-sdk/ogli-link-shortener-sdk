...
class LinkStatEntity extends OgliLinkShortenerEntityBase_1.OgliLinkShortenerEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'link_stat';
        this.name_ = 'link_stat';
        this.Name = 'LinkStat';
    }
    make() {
        return new LinkStatEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<LinkStat[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.LinkStatEntity = LinkStatEntity;
//# sourceMappingURL=LinkStatEntity.js.map