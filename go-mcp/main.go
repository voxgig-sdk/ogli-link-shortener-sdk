// Command OgliLinkShortener-mcp is an MCP server exposing the OgliLinkShortener
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OgliLinkShortener_list  — list records of an entity
//	OgliLinkShortener_load  — load a single record of an entity
//
