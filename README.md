...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ogli-link-shortener` | `npm install @voxgig-sdk/ogli-link-shortener` |
| Python | `voxgig-sdk-ogli-link-shortener` | `pip install voxgig-sdk-ogli-link-shortener` |
| PHP | `voxgig-sdk/ogli-link-shortener` | `composer require voxgig-sdk/ogli-link-shortener` |
| Golang | `github.com/voxgig-sdk/ogli-link-shortener-sdk/go` | `go get github.com/voxgig-sdk/ogli-link-shortener-sdk/go` |
| Ruby | `voxgig-sdk-ogli-link-shortener` | `gem install voxgig-sdk-ogli-link-shortener` |
| Lua | `voxgig-sdk-ogli-link-shortener` | `luarocks install voxgig-sdk-ogli-link-shortener` |
