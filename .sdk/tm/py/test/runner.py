...
class OgliLinkShortenerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OgliLinkShortenerTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = OgliLinkShortenerTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = OgliLinkShortenerTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
