...
// OgliLinkShortener SDK audit feature
...
class OgliLinkShortenerAuditFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _emit(OgliLinkShortenerContext $ctx, string $outcome): void
    {
