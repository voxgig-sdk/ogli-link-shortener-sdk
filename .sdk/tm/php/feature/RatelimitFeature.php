...
// OgliLinkShortener SDK ratelimit feature
...
class OgliLinkShortenerRatelimitFeature extends OgliLinkShortenerBaseFeature
{
    ...
    private function _acquire(OgliLinkShortenerContext $ctx): void
    {
    ...
    private function _track(OgliLinkShortenerContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
