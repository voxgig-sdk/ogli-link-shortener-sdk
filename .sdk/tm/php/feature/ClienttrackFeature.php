...
// OgliLinkShortener SDK clienttrack feature
...
class OgliLinkShortenerClienttrackFeature extends OgliLinkShortenerBaseFeature
{
    ...
    public function PostConstruct(OgliLinkShortenerContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OgliLinkShortener-SDK';
