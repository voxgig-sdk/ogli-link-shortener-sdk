...
// OgliLinkShortener SDK utility: graphql
//
...
class OgliLinkShortenerGraphql
{
    ...
    // equivalent.
    public static function body(OgliLinkShortenerContext $ctx): mixed
    {
    ...
    public static function errors(OgliLinkShortenerContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
