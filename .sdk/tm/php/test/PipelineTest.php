...
// OgliLinkShortener SDK pipeline test
//
...
{
    private static function utility(): OgliLinkShortenerUtility
    {
        return new OgliLinkShortenerUtility();
    }
    ...
    private static function ctx(array $over = []): OgliLinkShortenerContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new OgliLinkShortenerContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new OgliLinkShortenerOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof OgliLinkShortenerError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new OgliLinkShortenerOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = OgliLinkShortenerMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new OgliLinkShortenerOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = OgliLinkShortenerMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new OgliLinkShortenerOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = OgliLinkShortenerMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OgliLinkShortenerSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = OgliLinkShortenerMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new OgliLinkShortenerResponse([]),
            'result' => new OgliLinkShortenerResult([]),
        ]);
        [, $err] = OgliLinkShortenerMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new OgliLinkShortenerSpec([]),
            'response' => null,
            'result' => new OgliLinkShortenerResult([]),
        ]);
        [, $err] = OgliLinkShortenerMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new OgliLinkShortenerSpec(['step' => 's']),
            'response' => new OgliLinkShortenerResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new OgliLinkShortenerResult([]),
        ]);
        [, $err] = OgliLinkShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new OgliLinkShortenerSpec(['step' => 's']),
            'response' => new OgliLinkShortenerResponse(self::resp(200, ['v' => 1])),
            'result' => new OgliLinkShortenerResult([]),
        ]);
        [, $err] = OgliLinkShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new OgliLinkShortenerSpec(['step' => 's']),
            'response' => new OgliLinkShortenerResponse(self::resp(200, ['v' => 2])),
            'result' => new OgliLinkShortenerResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        OgliLinkShortenerMakeResponse::call($ctx);
    ...
    {
        $preset = new OgliLinkShortenerResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new OgliLinkShortenerSpec([]),
            'response' => new OgliLinkShortenerResponse([]),
            'result' => new OgliLinkShortenerResult([]),
        ...
        [$got, $err] = OgliLinkShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new OgliLinkShortenerResult([])]);
        [, $err] = OgliLinkShortenerMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new OgliLinkShortenerSpec([]), 'result' => null]);
        [, $err] = OgliLinkShortenerMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OgliLinkShortenerSpec(['step' => 's']),
            'result' => new OgliLinkShortenerResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new OgliLinkShortenerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OgliLinkShortenerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OgliLinkShortenerSpec(['step' => 's']),
            'result' => new OgliLinkShortenerResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new OgliLinkShortenerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OgliLinkShortenerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OgliLinkShortenerResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new OgliLinkShortenerSpec([]),
            'result' => new OgliLinkShortenerResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = OgliLinkShortenerMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OgliLinkShortenerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new OgliLinkShortenerError('boom', 'boom');
        $utility->fetcher = function (OgliLinkShortenerContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OgliLinkShortenerSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = OgliLinkShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (OgliLinkShortenerContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = OgliLinkShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(OgliLinkShortenerResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        OgliLinkShortenerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (OgliLinkShortenerContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OgliLinkShortenerSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = OgliLinkShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new OgliLinkShortenerResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new OgliLinkShortenerSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = OgliLinkShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = OgliLinkShortenerMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = OgliLinkShortenerMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new OgliLinkShortenerResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, OgliLinkShortenerDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new OgliLinkShortenerResult(['ok' => false])]);
        $this->expectException(OgliLinkShortenerError::class);
        OgliLinkShortenerDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new OgliLinkShortenerResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', OgliLinkShortenerMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        OgliLinkShortenerMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new OgliLinkShortenerBaseFeature();
        $b = new OgliLinkShortenerBaseFeature();
        OgliLinkShortenerFeatureAdd::call($ctx, $a);
        OgliLinkShortenerFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): OgliLinkShortenerBaseFeature
    {
        $f = new OgliLinkShortenerBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        OgliLinkShortenerFeatureAdd::call($ctx, self::named_feature('a'));
        OgliLinkShortenerFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        OgliLinkShortenerFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        OgliLinkShortenerFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        OgliLinkShortenerFeatureAdd::call($ctx, $replace);
        ...
        OgliLinkShortenerFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): OgliLinkShortenerContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new OgliLinkShortenerSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OgliLinkShortenerPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        OgliLinkShortenerPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new OgliLinkShortenerResponse(['headers' => null]),
            'result' => new OgliLinkShortenerResult([]),
        ]);
        OgliLinkShortenerResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        OgliLinkShortenerResultBody::call($ctx);
