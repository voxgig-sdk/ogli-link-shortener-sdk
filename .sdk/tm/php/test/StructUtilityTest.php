...
// OgliLinkShortener SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OgliLinkShortenerOmni::makeStructRunner(
    ...
    {
        return OgliLinkShortenerOmni::objmodel(OgliLinkShortenerOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return OgliLinkShortenerOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return OgliLinkShortenerOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OgliLinkShortenerOmni::structfix($now, Struct::undef()))
                        !== json_encode(OgliLinkShortenerOmni::structfix($val, Struct::undef()))) {
