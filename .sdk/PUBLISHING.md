...
|---|---|---|
| `ts/` | @voxgig-sdk/ogli-link-shortener-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ogli-link-shortener-sdk \
      --repository voxgig-sdk/ogli-link-shortener-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ogli-link-shortener-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ogli-link-shortener-sdk --id=<id>` removes it.
